...
// or Office caches collide across hosts). MUST be distinct from the Excel/Word/
// PowerPoint add-in GUIDs — reusing one makes Office cache both hosts as one add-in.
const addinId = env.ADDIN_MANIFEST_ID ?? '6a3f687f-012c-4ef5-8d3a-35aefd540fac';
