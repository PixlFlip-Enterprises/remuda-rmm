...
**Frame:** `docs/superpowers/specs/2026-06-14-billing-architecture-overview.md`,
`docs/superpowers/specs/2026-06-14-invoice-engine-design.md`.
...
- `docs/superpowers/specs/2026-06-14-billing-architecture-overview.md` — program frame, mapping-table rule, `payment.*`.
- `docs/superpowers/specs/2026-06-14-invoice-engine-design.md` — invoice/payment model, Stripe forward-compat (`:151-154`), reconcile point.
