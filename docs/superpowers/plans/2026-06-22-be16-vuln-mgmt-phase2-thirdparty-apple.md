...
**Source spec:** `internal/BE-16-vulnerability-management-v2.md`. **Spikes:** `internal/BE-16-spike-msrc-csaf.md`, `internal/BE-16-spike-apple.md`. **Predecessor plan:** `docs/superpowers/plans/2026-06-22-be16-vuln-mgmt-phase1-msrc.md`.
