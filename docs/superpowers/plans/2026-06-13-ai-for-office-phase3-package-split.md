...
1. Doc path updates: `FOLLOWUPS.md` Phase-3 → `[x]` + paths → `apps/excel-addin`; `docs/superpowers/plans/2026-06-13-ai-for-office-multihost.md` (mark Phase 3 done); `docs/.../2026-06-12-ai-for-office-1-foundation.md`, `docs/.../specs/2026-06-12-breeze-ai-for-office-design.md`, `docs/testing/FEATURE_TEST_LOG.md` path refs. Do NOT mass-rewrite the historical `2026-06-12-ai-for-office-5-excel-addin.md`.
